...
# Flux = -0.92 mJy, rms = 0.15 mJy, S/N = -6.2
...
beam :  PA   -62    0.31 x  0.25 arcsec   #pix/beam:    99
center pixel    150,  150
Annulus is between 5.0 and 20.0 arcsec
Subtracting offset of -0.022 mJy/beam from image
RMS in annulus is 0.154

#   i  radius    #pix    total      rms     snr   beam_frac
#      (asec)            (mJy)     (mJy)
   0    0.000       1     0.17    0.149     1.1   0.010
   1    0.100      37     0.16    0.151     1.0   0.311
   2    0.200     137     0.15    0.174     0.8   0.743
   3    0.300     317     0.19    0.206     0.9   0.954
   4    0.400     553     0.21    0.253     0.8   0.995
   5    0.500     877     0.08    0.291     0.3   1.000
   6    0.600    1257    -0.07    0.404    -0.2   1.000
   7    0.700    1709    -0.09    0.433    -0.2   1.000
   8    0.800    2233    -0.15    0.591    -0.3   1.000
   9    0.900    2821    -0.23    0.383    -0.6   1.000
