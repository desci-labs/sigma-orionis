...
# Flux = 0.02 mJy, rms = 0.15 mJy, S/N = 0.2
...
uvmodelfit(vis       = contvis,
           ...
           niter     = 10)
'''
reduced chi2=2.81284
I = 0.000563857 +/- 8.00041e-05
x = -0.101715 +/- 0.0191812 arcsec
y = 0.0288909 +/- 0.0178888 arcsec
'''
...
#      (asec)            (mJy)     (mJy)
   0    0.000       1     0.64    0.136     4.7   0.010
   1    0.050       9     0.64    0.158     4.1   0.090
   2    0.100      37     0.66    0.149     4.4   0.320
   3    0.150      81     0.69    0.142     4.8   0.567
   4    0.200     137     0.73    0.130     5.6   0.757 < -- high
   5    0.250     221     0.78    0.180     4.3   0.896
   6    0.300     317     0.80    0.204     3.9   0.960
   7    0.350     429     0.81    0.216     3.8   0.987
   8    0.400     553     0.81    0.265     3.1   0.996
   9    0.450     709     0.78    0.292     2.7   0.999
  10    0.500     877     0.76    0.319     2.4   1.000
  11    0.550    1049     0.75    0.396     1.9   1.000
  12    0.600    1257     0.72    0.382     1.9   1.000
  13    0.650    1481     0.67    0.377     1.8   1.000
  14    0.700    1709     0.61    0.303     2.0   1.000
