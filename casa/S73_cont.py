...
# Peak = 0.68 mJy, rms = 0.15 mJy, S/N = 4.6
...
# Flux = 0.19 mJy, rms = 0.15 mJy, S/N = 1.3
...
Subtracting offset of -0.027 mJy/beam from image
RMS in annulus is 0.15

#   i  radius    #pix    total      rms     snr   beam_frac
#      (asec)            (mJy)     (mJy)
   0    0.000       1    -0.15    0.136    -1.1   0.010
   1    0.050       9    -0.15    0.154    -1.0   0.085
   2    0.100      37    -0.15    0.138    -1.1   0.305
   3    0.150      81    -0.15    0.157    -1.0   0.545
   4    0.200     137    -0.17    0.211    -0.8   0.734
   5    0.250     221    -0.23    0.186    -1.2   0.878
   6    0.300     317    -0.32    0.234    -1.4   0.949
   7    0.350     429    -0.42    0.234    -1.8   0.981
   8    0.400     553    -0.50    0.279    -1.8   0.994
   9    0.450     709    -0.52    0.328    -1.6   0.998
