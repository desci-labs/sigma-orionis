...
# Flux = 1.01 mJy, rms = 0.15 mJy, S/N = 6.8
...
beam :  PA   -60    0.31 x  0.25 arcsec   #pix/beam:    98
center pixel    150,  150
Annulus is between 5.0 and 20.0 arcsec
Subtracting offset of 0.011 mJy/beam from image
RMS in annulus is 0.152

#   i  radius    #pix    total      rms     snr   beam_frac
#      (asec)            (mJy)     (mJy)
   0    0.000       1    -0.04    0.159    -0.3   0.010
   1    0.050       9    -0.05    0.139    -0.4   0.088
   2    0.100      37    -0.07    0.141    -0.5   0.314
   3    0.150      81    -0.10    0.145    -0.7   0.558
   4    0.200     137    -0.12    0.138    -0.9   0.748
   5    0.250     221    -0.15    0.158    -1.0   0.889
   6    0.300     317    -0.17    0.191    -0.9   0.956
   7    0.350     429    -0.19    0.212    -0.9   0.985
   8    0.400     553    -0.24    0.252    -1.0   0.995
   9    0.450     709    -0.30    0.306    -1.0   0.999
  10    0.500     877    -0.36    0.288    -1.3   1.000
  11    0.550    1049    -0.42    0.354    -1.2   1.000
  12    0.600    1257    -0.38    0.271    -1.4   1.000
  13    0.650    1481    -0.35    0.383    -0.9   1.000
  14    0.700    1709    -0.27    0.472    -0.6   1.000
