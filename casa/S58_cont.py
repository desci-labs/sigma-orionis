...
# Peak = 0.63 mJy, rms = 0.14 mJy, S/N = 4.7
...
# Flux = -0.37 mJy, rms = 0.14 mJy, S/N = -2.8
...
Subtracting offset of 0.018 mJy/beam from image
RMS in annulus is 0.142

#   i  radius    #pix    total      rms     snr   beam_frac
#      (asec)            (mJy)     (mJy)
   0    0.000       1    -0.17    0.122    -1.4   0.010
   1    0.050       9    -0.16    0.145    -1.1   0.087
   2    0.100      37    -0.15    0.136    -1.1   0.310
   3    0.150      81    -0.13    0.150    -0.9   0.553
   4    0.200     137    -0.13    0.175    -0.8   0.743
   5    0.250     221    -0.15    0.144    -1.1   0.885
   6    0.300     317    -0.18    0.184    -1.0   0.953
   7    0.350     429    -0.24    0.188    -1.3   0.984
   8    0.400     553    -0.30    0.232    -1.3   0.995
   9    0.450     709    -0.36    0.224    -1.6   0.999
  10    0.500     877    -0.44    0.281    -1.6   1.000
  11    0.550    1049    -0.50    0.336    -1.5   1.000
  12    0.600    1257    -0.52    0.405    -1.3   1.000
  13    0.650    1481    -0.51    0.357    -1.4   1.000
  14    0.700    1709    -0.50    0.326    -1.5   1.000
