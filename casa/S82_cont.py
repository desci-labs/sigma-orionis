...
# Peak = 0.73 mJy, rms = 0.15 mJy, S/N = 4.9
...
# Flux = -0.96 mJy, rms = 0.15 mJy, S/N = -6.4
...
beam :  PA   -61    0.33 x  0.25 arcsec   #pix/beam:   103
center pixel    150,  150
Annulus is between 5.0 and 20.0 arcsec
Subtracting offset of 0.008 mJy/beam from image
RMS in annulus is 0.156

#   i  radius    #pix    total      rms     snr   beam_frac
#      (asec)            (mJy)     (mJy)
   0    0.000       1    -0.24    0.138    -1.7   0.010
   1    0.050       9    -0.23    0.137    -1.7   0.084
   2    0.100      37    -0.22    0.138    -1.6   0.301
   3    0.150      81    -0.20    0.168    -1.2   0.539
   4    0.200     137    -0.18    0.135    -1.3   0.728
   5    0.250     221    -0.17    0.172    -1.0   0.874
   6    0.300     317    -0.17    0.170    -1.0   0.946
   7    0.350     429    -0.17    0.216    -0.8   0.980
   8    0.400     553    -0.19    0.266    -0.7   0.993
   9    0.450     709    -0.23    0.276    -0.8   0.998
  10    0.500     877    -0.31    0.369    -0.8   1.000
  11    0.550    1049    -0.41    0.283    -1.5   1.000
  12    0.600    1257    -0.55    0.412    -1.3   1.000
  13    0.650    1481    -0.63    0.384    -1.6   1.000
  14    0.700    1709    -0.68    0.291    -2.4   1.000
