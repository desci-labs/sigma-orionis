...
# Peak = 0.74 mJy, rms = 0.16 mJy, S/N = 4.7
...
# Flux = 0.84 mJy, rms = 0.16 mJy, S/N = 5.4
...
'''
reduced chi2=2.86
I = 0.0010414 +/- 0.000159235
x = -0.028164 +/- 0.0165189 arcsec
y = -0.0142638 +/- 0.0211632 arcsec
a = 0.255754 +/- 0.0680858 arcsec <-- bad
r = 0.137225 +/- 0.915037
p = -11.6724 +/- 15.2308 deg
...
uvmodelfit(vis       = contvis,
           ...
           niter     = 10)
'''
I = 0.000791026 +/- 9.00432e-05
x = -0.0208371 +/- 0.0165816 arcsec
y = -0.0131208 +/- 0.0144664 arcsec
'''
