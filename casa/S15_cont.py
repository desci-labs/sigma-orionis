...
# Peak = 0.66 mJy, rms = 0.14 mJy, S/N = 4.8
...
Subtracting offset of -0.026 mJy/beam from image
RMS in annulus is 0.143

#   i  radius    #pix    total      rms     snr   beam_frac
#      (asec)            (mJy)     (mJy)
   0    0.000       1    -0.05    0.149    -0.4   0.010
   1    0.100      37    -0.07    0.152    -0.4   0.319
   2    0.200     137    -0.08    0.180    -0.4   0.756
   3    0.300     317    -0.04    0.165    -0.2   0.959
   4    0.400     553     0.08    0.254     0.3   0.996
   5    0.500     877     0.31    0.302     1.0   1.000
   6    0.600    1257     0.49    0.371     1.3   1.000
   7    0.700    1709     0.48    0.559     0.9   1.000
   8    0.800    2233     0.47    0.483     1.0   1.000
   9    0.900    2821     0.44    0.607     0.7   1.000
