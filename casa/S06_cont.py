...
# did light cleaning in auto mode
...
# Peak = 0.59 mJy, rms = 0.13 mJy, S/N = 4.5
...
# Flux = 0.95 mJy, rms = 0.13 mJy, S/N = 7.2
...
image noise     0.133 mJy
beam :  PA   -63    0.30 x  0.25 arcsec   #pix/beam:    95
center pixel    150,  150
Annulus is between 5.0 and 20.0 arcsec
Subtracting offset of 0.000 mJy/beam from image
RMS in annulus is 0.126

#   i  radius    #pix    total      rms     snr   beam_frac
#      (asec)            (mJy)     (mJy)
   0    0.000       1     0.04    0.140     0.3   0.011
   1    0.100      37     0.03    0.120     0.2   0.323
   2    0.200     137     0.01    0.132     0.1   0.761
   3    0.300     317     0.01    0.184     0.1   0.961
   4    0.400     553     0.08    0.245     0.3   0.996
   5    0.500     877     0.16    0.358     0.4   1.000
   6    0.600    1257     0.18    0.366     0.5   1.000
   7    0.700    1709     0.18    0.407     0.4   1.000
   8    0.800    2233     0.26    0.511     0.5   1.000
   9    0.900    2821     0.51    0.949     0.5   1.000
