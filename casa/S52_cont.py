...
# Peak = 0.65 mJy, rms = 0.15 mJy, S/N = 4.2
...
# Flux = 0.17 mJy, rms = 0.15 mJy, S/N = 1.1
...
RMS in annulus is 0.165

#   i  radius    #pix    total      rms     snr   beam_frac
#      (asec)            (mJy)     (mJy)
   0    0.000       1    -0.05    0.163    -0.3   0.010
   1    0.050       9    -0.04    0.148    -0.3   0.089
   2    0.100      37    -0.02    0.134    -0.2   0.316
   3    0.150      81     0.01    0.156     0.1   0.561
   4    0.200     137     0.06    0.157     0.4   0.751
   5    0.250     221     0.11    0.177     0.6   0.891
   6    0.300     317     0.12    0.203     0.6   0.957
   7    0.350     429     0.07    0.209     0.3   0.985
   8    0.400     553    -0.02    0.252    -0.1   0.995
   9    0.450     709    -0.10    0.323    -0.3   0.999
  10    0.500     877    -0.11    0.285    -0.4   1.000
  11    0.550    1049    -0.07    0.305    -0.2   1.000
  12    0.600    1257     0.05    0.432     0.1   1.000
  13    0.650    1481     0.10    0.427     0.2   1.000
  14    0.700    1709     0.14    0.471     0.3   1.000
