...
# Peak = 0.66 mJy, rms = 0.15 mJy, S/N = 4.4
...
# Flux = 0.48 mJy, rms = 0.15 mJy, S/N = 3.2
...
uvmodelfit(vis       = contvis,
           ...
           niter     = 10)
'''
I = 0.00044725 +/- 8.37844e-05
x = -0.0699812 +/- 0.0260183 arcsec
y = 0.0474246 +/- 0.023535 arcsec

'''

### NOTE: doesn't matter if fixed or free source location 
### NOTE: doesn't matter if using [320,320] or not, still detection
...
RMS in annulus is 0.139

#   i  radius    #pix    total      rms     snr   beam_frac
#      (asec)            (mJy)     (mJy)
   0    0.000       1     0.44    0.144     3.1   0.010
   1    0.050       9     0.44    0.167     2.6   0.088
   2    0.100      37     0.43    0.130     3.3   0.314
   3    0.150      81     0.41    0.145     2.9   0.559
   4    0.200     137     0.40    0.177     2.3   0.749
   5    0.250     221     0.39    0.147     2.6   0.889
   6    0.300     317     0.35    0.237     1.5   0.956
   7    0.350     429     0.31    0.225     1.4   0.985
   8    0.400     553     0.27    0.287     0.9   0.995
   9    0.450     709     0.20    0.275     0.7   0.999
  10    0.500     877     0.18    0.374     0.5   1.000
  11    0.550    1049     0.19    0.343     0.5   1.000
  12    0.600    1257     0.21    0.345     0.6   1.000
  13    0.650    1481     0.26    0.382     0.7   1.000
  14    0.700    1709     0.31    0.358     0.9   1.000
