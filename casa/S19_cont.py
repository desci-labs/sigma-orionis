...
# Peak = 0.59 mJy, rms = 0.13 mJy, S/N = 4.4
...
# Flux = -0.19 mJy, rms = 0.14 mJy, S/N = -1.3
...
uvmodelfit(vis       = contvis,
           ...
           niter     = 10)
'''
I = 0.000265274 +/- 7.91677e-05
x = 0 +/- 0 arcsec
y = 0 +/- 0 arcsec
'''


#### measure flux as point source with floating location
uvmodelfit(vis       = contvis,
           comptype  = 'P',
           sourcepar = [img_flx,dx,dy],
           varypar   = [T,T,T],
           niter     = 10)
'''
I = 0.00017619 +/- 7.91677e-05
x = 0.847071 +/- 0.0613117 arcsec
y = -0.347497 +/- 0.05634 arcsec
'''
...
RMS in annulus is 0.136

#   i  radius    #pix    total      rms     snr   beam_frac
#      (asec)            (mJy)     (mJy)
   0    0.000       1     0.23    0.138     1.7   0.010
   1    0.050       9     0.24    0.135     1.8   0.090
   2    0.100      37     0.25    0.123     2.0   0.320
   3    0.150      81     0.26    0.142     1.8   0.567
   4    0.200     137     0.26    0.159     1.6   0.757
   5    0.250     221     0.23    0.152     1.5   0.896
   6    0.300     317     0.18    0.155     1.1   0.960
   7    0.350     429     0.13    0.164     0.8   0.987
   8    0.400     553     0.11    0.231     0.5   0.996
   9    0.450     709     0.09    0.230     0.4   0.999
  10    0.500     877     0.11    0.208     0.5   1.000
  11    0.550    1049     0.10    0.276     0.4   1.000
  12    0.600    1257     0.02    0.320     0.1   1.000
  13    0.650    1481    -0.11    0.405    -0.3   1.000
  14    0.700    1709    -0.24    0.467    -0.5   1.000
  15    0.750    1961    -0.33    0.394    -0.8   1.000
  16    0.800    2233    -0.38    0.427    -0.9   1.000
  17    0.850    2537    -0.40    0.626    -0.6   1.000
  18    0.900    2821    -0.38    0.464    -0.8   1.000
  19    0.950    3149    -0.39    0.356    -1.1   1.000
